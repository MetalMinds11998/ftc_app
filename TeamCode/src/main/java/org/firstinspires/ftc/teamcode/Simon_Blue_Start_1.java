...
@Autonomous(name="SIMON: Blue_Start_1", group="SIMON")

public class Simon_Blue_Start_1 extends LinearOpMode {
	...
	double Flickr_Fwd = 0.3; // Jewel Flick Forward position
...
// Now move off the ramp to the cryptolocker
			encoderDrive(0.15, 580, 1, 6); // Reverse off balance Board
			sleep(250);
			encoderDrive(0.3, 100, 3, 4 ); // Move Sideways to line up
			sleep(250);
			turn(83); // Turn 90 Degrees to face CrypotoBox
			sleep(250);
			encoderDrive(0.3, 200, 0, 4);
			sleep(250);
			gripper_1.setPosition(Gripper1_Init);
			gripper_2.setPosition(Gripper2_Init);
			sleep(250);
