...
@Autonomous(name="SIMON: Red_Start_2", group="SIMON")

public class Simon_Red_Start_2 extends LinearOpMode {
...
// Now move off the ramp to the cryptolocker
			encoderDrive(0.2, 650, 0, 20); // Forward off balance Board
			sleep(250);
			encoderDrive(0.2, 750, 3, 3); // Aligning glyph with cryptobox
			sleep(250);
