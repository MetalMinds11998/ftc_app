...
@Autonomous(name="SIMON: Red_Start_1", group="SIMON")

public class Simon_Red_Start_1 extends LinearOpMode {
...
// Now move off the ramp to the cryptolocker
			encoderDrive(0.2, 900, 0, 20); // Forward off balance Board
			sleep(250);
			encoderDrive(0.2, 100, 3, 3); // Reverse off balance Board
			sleep(250);
			turn(90); // Turn 90 Degrees to face CrypotoBox
			sleep(250);
			encoderDrive(0.3, 300, 0, 4);
			sleep(250);
			gripper_1.setPosition(Gripper1_Init);
			gripper_2.setPosition(Gripper2_Init);
			sleep(250);
